...
const Whatsapp = () => {
    ...
    return (
        <a href={isMobile ? 'https://wa.me/5511982581886' : 'https://web.whatsapp.com/send/?phone=5511982581886&text&type=phone_number&app_absent=0'} target="_blank" rel="noopener noreferrer">
