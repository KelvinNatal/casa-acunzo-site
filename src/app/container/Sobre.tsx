...
const Sobre = () => {
  return (
    <section className='w-full h-full flex justify-center' id="sobre">
        <div className='w-[80vw] h-[80vh] flex p-2 items-center'>
            <div className='w-6/12 h-full  rounded-md flex flex-col items-center justify-center'>
                <Image
                ...
                <button className='w-[250px] h-100 bg-slate-950 text-slate-50 mt-4 p-2 rounded-md'>Contate-me!</button>
            </div>
            <div className='w-6/12 h-full flex flex-col items-center justify-center'>
                <h1 className='font-bold text-5xl mb-10'>Sobre Nós</h1>
                <div className='w-[450px] h-100 flex flex-col items-center text-justify'>
